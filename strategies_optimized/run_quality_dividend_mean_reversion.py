"""
Run Quality Dividend Mean Reversion Strategy Backtest
"""
...
from quality_dividend_mean_reversion import OptimizedStrategy
...
if __name__ == '__main__':
    print("\n" + "="*80)
    print("Quality Dividend Mean Reversion")
    print("="*80 + "\n")
